...
Component({
    ...
    methods: {
        initAnimation() {
            wx.createSelectorQuery().in(this).select('.f-noticebar-content-wrap').boundingClientRect((wrapRect) => {
                wx.createSelectorQuery().in(this).select('.f-noticebar-content').boundingClientRect((rect) => {
